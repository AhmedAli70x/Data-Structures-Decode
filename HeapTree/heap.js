...
pop(){//can delete top queue only
    ...
    while(left_index < this.#size){
        ...
        if( this.#data_list[right_index] != null && this.#data_list[right_index] < this.#data_list[left_index]){
        ...
        var temp = this.#data_list[smaller_index];
        this.#data_list[smaller_index] = this.#data_list[i];
        this.#data_list[i] = temp;
