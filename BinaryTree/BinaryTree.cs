    ...
    public class BinaryTree<Tdata> where Tdata : IComparable<Tdata>
    {
        ...
        public void BsDelete(Tdata _data){
            ...
            if(nodeAndParentInfo.Node.Left != null && nodeAndParentInfo.Node.Right !=null){
                BsDelete_With_Childs(nodeAndParentInfo.Node);
            } 
            else if (nodeAndParentInfo.Node.Left != null ^ nodeAndParentInfo.Node.Right != null){
               BSDelete_With_OneChild(nodeAndParentInfo.Node);
            }
            else{
         ...
         void BsDelete_Leaf(NodeAndParent nodeAndParent){
                if (nodeAndParent.Parent == null){
                    ...
                    else{ nodeAndParent.Parent.Right = null;}
                    

                }

        }
        void BSDelete_With_OneChild(TreeNode NodetoDelete){//node has one child
        ...
        void BsDelete_With_Childs(TreeNode nodeToDelete){
                TreeNode CurrentNode = nodeToDelete.Right;
                TreeNode parent = null;

                while(CurrentNode.Left != null){//smallestNode
                    parent = CurrentNode;
                ...
                //garbege collector will delete the data;
